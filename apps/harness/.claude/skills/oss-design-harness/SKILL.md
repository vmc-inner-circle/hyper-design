...
5. **덜 만든다.** 확정 문서(`design-rules.md`·`screens.md`)에 선언되지 않은 variant·상태 프레임은 만들지 않는다. 게이트는 빠진 것뿐 아니라 **선언에 없는 것도 실패로 잡는다.** "혹시 필요할까 봐" 만든 것은 유지보수 대상이 되고 Figma 조작을 느리게 만든다.
